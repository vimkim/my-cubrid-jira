...
- **변경 범위 / 영향**: 코드 변경 없음. 산출물은 CBRD-27014 발표자료 계획, 슬라이드 구성, 시각화 방향, 리허설 일정이다. 입력 자료는 CBRD-27014, CBRD-26583, CBRD-26582, `/home/vimkim/gh/cubrid-oos-context/OOS-CONTEXT.md`, `feat/oos` 현재 스펙이다.
...
> 사용자 메시지의 워크샵 날짜는 "July 17 Thursday" 였으나, 2026-07-17 은 금요일이다. 일정 표기에는 `2026-07-17 금요일` 을 사용한다.
...
HTML/CSS/SVG 기반으로 작성하면 두 발표의 공통 그림을 재사용하기 쉽다. 특히 다음 그림은 SVG 로 만들 가치가 있다.
...
|------|-----------|
| 발표 시간 | `TBD - 합의 미확인` |
| 최종 파일 형식 | HTML/CSS/SVG, PPT, PDF 중 `TBD - 합의 미확인` |
| 라이브 데모 포함 여부 | `TBD - 합의 미확인` |
| 워크샵에서 미해결 리스크를 어디까지 공개할지 | `TBD - 합의 미확인` |
| 발표자료 저장 위치와 첨부 방식 | `TBD - 합의 미확인` |
